parser grammar SXParser;

options { tokenVocab=SXLexer; } //superClass = CSharpParserBase;
...
equality_expression
	: relational_expression (('=' | OP_NE)  relational_expression)* //((OP_EQ | OP_NE)  relational_expression)*
	;
...
simple_embedded_statement
	...
	// | IF expression if_body (ELSE if_body)?               #ifStatement
	| IF conditional_expression if_body (ELSE if_body)?               #ifStatement
